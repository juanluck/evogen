...
public class SCHWEFELNOISE extends Evaluator {

test_func mytest = null;
    
    public SCHWEFELNOISE() {
        benchmark bench = new benchmark();
        mytest = bench.testFunctionFactory(4, Configuration.chromosome_size);
    }
    ...
    public Object clone() {
        SCHWEFELNOISE pp = new SCHWEFELNOISE();
