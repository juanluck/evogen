...
public class HEPPEAKS extends geneura.org.Evaluator{
		      ...
		      for(int p=0; p<P; p++)	// For every peak do
			    {
			      ...
			      if ((L-hd)>nearest_peak){
		      		...
		      		return nearest_peak*Math.pow(heigth[n_peak_index], P);
		  }
