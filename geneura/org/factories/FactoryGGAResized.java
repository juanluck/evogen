...
import geneura.org.gGA.GGAResized;
...
import geneura.org.statistics.ObserverTauRho;
...
public class FactoryGGAResized {
	public static Algorithm createBinaryGGA(){
		...
		if (Configuration.tau != -1 || Configuration.rho != -1){
			observer.registerObservable(new ObserverTauRho());
		}

		
		PanmicticResizing population = new PanmicticResizing(Configuration.population_size,individual, evaluator);
