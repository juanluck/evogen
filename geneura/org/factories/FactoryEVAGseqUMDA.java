...
import geneura.org.evoag.EVAGseqUMDA;
...
public class FactoryEVAGseqUMDA {
public static Algorithm createNewscastEVAGseqUMDA(){
		...
		EVAGseqUMDA evagsequmda = new EVAGseqUMDA();
		evagsequmda.setAlgorithm(sn, evaluator, null, selection, crossover, mutation, termination);
	
		evagsequmda.attach(observer);
		Observer.restart();
		return evagsequmda;
		
	}

//TODO: UMDA using Watts-Strogatz Neighbourhood
