...
public class NumberGeneration implements ITermination,IObservable{
	
	protected static long _max_generation = 100000;
	
	public NumberGeneration(long max_generation) {
		this._max_generation = max_generation;
	}
		

	public boolean isFinish() {
		return Termination.get_n_generation() >= _max_generation;
	}

	public String getStateAsString() {
		return (isFinish()) ? Termination.NUMBERGENERATION:"";
		
	}
	
	
	public static long get_max_generation() {
		return _max_generation;
	}


	public Object clone(){
		return new NumberEvaluation(this._max_generation);
	}
