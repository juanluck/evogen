...
*/
package geneura.org.replacement;

import geneura.org.individuals.Individual;
import geneura.org.neighborhood.INeighborhood;

/**
 * Replace the worst individual in a given neighborhood
 * 
 *
 */
public class ReplaceWorst implements IReplacement{

	
	public void replace(Individual ind, INeighborhood neighborhood) {
				
		neighborhood.setIndividual(neighborhood.getWorst(), ind);
	}
